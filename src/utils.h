 ...
 * @file
 * @ingroup utils
 * @brief String, time and other various helpers.
 ...
 *
 * @return A `gint64` monotonic time representation
 */
gint64 time_monotonic_now(void);

/**
 * Get the current real time. Might jump backward on clock adjustments!
 *
 * @return A `gint64` real time representation
 */
 ...
 * @return A bool that is true when it succeeds
 */
bool safe_setenv(const char* key, const char* value);

/**
 * Some sections are handled differently in dunst. This function tells whether a
 * sections is such a special section.
 *
 * @param s The name of the section
 * @return A bool whether this section is one of the special sections
 */
 ...
 *
 * @param s The name of the section
 * @return A bool whether this section is deprecated
 */
 ...
 * This function checks if @p path can be resolved and makes
 ...
 * @return The result of the fopen() call.
