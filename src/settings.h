...
enum mouse_action
{
    ...
    MOUSE_OPEN_URL,
    MOUSE_ACTION_END =
        LIST_END /* indicates the end of a list of mouse actions */
};
...
enum origin_values
{
    ...
    ORIGIN_BOTTOM_RIGHT = ZWLR_LAYER_SURFACE_V1_ANCHOR_BOTTOM
...
struct settings
{
    ...
    struct position offset; // NOTE: we rely on the fact that lenght and
