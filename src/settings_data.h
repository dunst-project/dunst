...
static const struct setting allowed_settings[] = {
        ...
        },
        {
                .name = "ignore_close",
                .section = "*",
                .description = "Setting this to true will prevent the notification from being dismissed by the application that requested the notification.",
                .type = TYPE_CUSTOM,
                .default_value = "*",
                .value = NULL,
                .parser = string_parse_enum,
                .parser_data = boolean_enum_data,
                .rule_offset = offsetof(struct rule, ignore_close),
        },
        {
                .name = "history_ignore",
                .section = "*",
