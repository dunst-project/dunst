 ...
 * - Test that it works
 *
 *   An example of making a setting a rule can be found in commit
 * edc6f5a8c7a51a56b591cfa72618a43adc7b8d11
 */

static const struct rule empty_rule = {.name = "empty",
                                       .appname = NULL,
                                       .action_name = NULL,
                                       .summary = NULL,
                                       .body = NULL,
...
static const struct setting allowed_settings[] = {
    ...
    },
    {
        .name = "category",
        .section = "*",
        .description = "The category of the notification as defined by the "
                       "notification spec. See "
                       "https://specifications.freedesktop.org/"
                       "notification-spec/latest/ar01s06.html",
        .type = TYPE_STRING,
        .default_value = "*",
        .value = NULL,
        .parser = NULL,
    ...
    },
    {
        ...
        .description =
            ...
            "comparison to the appname, the desktop-entry won't get localized.",
        .type = TYPE_STRING,
        .default_value = "*",
        .value = NULL,
        .parser = NULL,
    ...
    },
    {
        ...
        .section = "*",
        .description = "Match if the notification has been declared as "
                       "transient by the client or by some other rule.",
        .type = TYPE_CUSTOM,
        .default_value = "*",
        .value = NULL,
    ...
    },
    {
        .name = "msg_urgency",
        .section = "*",
        .description = "Matches the urgency of the notification as set by the "
    ...
    },
    {
        .name = "stack_tag",
        .section = "*",
        .description = "Matches the stack tag of the notification as set by "
                       "the client or by some other rule.",
        .type = TYPE_STRING,
        .default_value = "*",
        .value = NULL,
        .parser = NULL,
    ...
    },
    {
        ...
        .description =
            ...
            "fullscreen window is focused. One of show, delay, or pushback.",
        .type = TYPE_CUSTOM,
        .default_value = "show",
        .value = NULL,
        .parser = string_parse_enum,
    ...
    },
    {
        .name = "new_icon",
        .section = "*",
        .description = "Updates the icon of the notification, it should be a "
    ...
    },
    {
        .name = "set_stack_tag",
        .section = "*",
        .description = "Sets the stack tag for the notification, notifications "
                       "with the same (non-empty) stack tag will replace "
    ...
    },
    {
        .name = "skip_display",
        .section = "*",
        .description = "Setting this to true will prevent the notification "
                       "from being displayed initially but will be saved in "
    ...
    },
    {
        .name = "hide_text",
        .section = "*",
        .description = "Skip rendering summary and body text in notification "
                       "window (keeps icon and progress bar)",
        .type = TYPE_CUSTOM,
        .default_value = "*",
        .value = NULL,
        .parser = string_parse_enum,
    ...
    },
    {
        ...
        .section = "global",
        .description =
            "Scale smaller icons up to this size, set to 0 to disable. If "
            "max_icon_size also specified, that has the final say.",
        .type = TYPE_INT,
        .default_value = "*",
        .value = NULL,
        .parser = NULL,
    ...
    },
    {
        ...
        .section = "global",
        .description = "Always run rule-defined scripts, even if the "
                       "notification is suppressed with format = \"\".",
        .type = TYPE_CUSTOM,
        .default_value = "true",
    ...
    },
    {
        ...
        .type = TYPE_STRING,
        .default_value = "/usr/share/icons/gnome/16x16/status/:/usr/share/"
                         "icons/gnome/16x16/devices/",
    ...
    },
    {
        .name = "origin",
        .section = "global",
        .description = "Specifies the where the notification is positioned "
                       "before offsetting.",
        .type = TYPE_CUSTOM,
