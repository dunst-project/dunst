...
{
    char *urls = extract_urls(
        "Hi from https://www.example.com and ftp://www.example.com!");
...
{
    char *urls = extract_urls(
        "Hi from https://www.example.com:8100 and have a nice day!");
...
{
    char *urls = extract_urls(
        "Hi from https://www.example.com:8100/testpath and have a nice day!");
...
{
    char *urls =
        extract_urls("Hi from https://www.example.com:8100/testpath#anchor and "
                     "have a nice day!");
