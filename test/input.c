...
TEST test_notification_at(void)
{
    ...
    int top_notification_height =
        get_notification_clickable_height(top_notification, true, false);

    struct notification *middle_notification =
        g_slist_nth_data(notifications, 1);
    int middle_notification_height =
        get_notification_clickable_height(middle_notification, false, false);

    struct notification *bottom_notification =
        g_slist_nth_data(notifications, 2);
    int bottom_notification_height =
        get_notification_clickable_height(bottom_notification, false, true);
