...
#define GREATEST_TESTNAME_BUF_SIZE 128
    ...
    typedef int
    greatest_equal_cb(const void *expd, const void *got, void *udata);
    ...
    int greatest_do_assert_equal_t(const void *expd,
                                   const void *got,
...
#define GREATEST_ASSERT_STR_EQm(MSG, EXP, GOT)                                 \
    do {                                                                       \
        GREATEST_ASSERT_EQUAL_Tm(                                              \
            MSG, EXP, GOT, &greatest_type_info_string, NULL);                  \
    } while (0)
...
#define GREATEST_ASSERT_STRN_EQm(MSG, EXP, GOT, SIZE)                          \
    do {                                                                       \
        size_t size = SIZE;                                                    \
        GREATEST_ASSERT_EQUAL_Tm(                                              \
            MSG, EXP, GOT, &greatest_type_info_string, &size);                 \
    } while (0)
...
#define GREATEST_ASSERT_MEM_EQm(MSG, EXP, GOT, SIZE)                           \
    do {                                                                       \
        ...
        env.size = SIZE;                                                       \
        GREATEST_ASSERT_EQUAL_Tm(                                              \
            MSG, env.exp, env.got, &greatest_type_info_memory, &env);          \
    } while (0)
...
#define GREATEST_MAIN_DEFS()                                                   \
    ...
    static int greatest_name_match(                                            \
        const char *name, const char *filter, int res_if_none)                 \
    {                                                                          \
        size_t offset = 0;                                                     \
        ...
        for (i = 1; i < argc; i++) {                                           \
            if (argv[i][0] == '-') {                                           \
                ...
                case 'a': /* abort() on fail flag */                           \
                    ...
                    break;                                                     \
                case 'l': /* list only (dry run) */ greatest_list_only();      \
                    break;                                                     \
    ...
    {                                                                          \
        ...
        greatest_info.teardown_udata = udata;                                  \
                                                                               ...
                                                                               \
    static int greatest_string_equal_cb(                                       \
        const void *expd, const void *got, void *udata)                        \
    {                                                                          \
    ...
    greatest_type_info greatest_type_info_string = {                           \
        ...
        greatest_string_printf_cb,                                             \
                                                                               ...
                                                                               \
    static int greatest_memory_equal_cb(                                       \
        const void *expd, const void *got, void *udata)                        \
    {                                                                          \
    ...
    {                                                                          \
        ...
        fprintf(stderr,                                                        \
                "init_second_pass: a %lu, c %lu, state %lu\n",                 \
                p->a,                                                          \
                p->c,                                                          \
                p->state);                                                     \
        return 1;                                                              \
