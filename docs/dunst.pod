...
=item B<file_handler> (default: "/usr/bin/thunar")

The command that will be run when opening a URL beginning with file://. The
URL to be opened will be appended to the end of the value of this setting.
