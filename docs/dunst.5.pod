...
override_pause_level to 2 and then set dunst's pause level to 2. This will cause dunst to
only show battery level notification (and other notifications with override_pause_level >= 2),
